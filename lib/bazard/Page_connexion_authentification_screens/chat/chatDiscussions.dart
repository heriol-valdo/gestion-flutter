...
import 'package:flutter_firebase/bazard/models/message.dart';

import 'package:fluttertoast/fluttertoast.dart';
import 'package:image_picker/image_picker.dart';

import '../../Database_services/message_database.dart';
import 'message_item.dart';

class ChatDiscussions extends StatefulWidget {
  const ChatDiscussions({Key? key, required this.chatParamsDiscussions}) : super(key: key);
  final ChatParamsDiscussions chatParamsDiscussions;

  @override
  _ChatState createState() => _ChatState(chatParamsDiscussions);
}

class _ChatState extends State<ChatDiscussions> {
  ...
  final ChatParamsDiscussions chatParams;
  ...
  Future uploadFile(PickedFile file) async {
    ...
    try {
      ...
      Fluttertoast.showToast(msg: "Erreur reessayer encore!");
    }
  }
  ...
  void onSendMessage(String content, int type) {
    if (content.trim() != '') {
      ...
      Fluttertoast.showToast(
          msg: "vous n'avez rien envoyez", backgroundColor: Colors.red, textColor: Colors.white);
    }
  }
}
