...
class _ChatState extends State<Chat> {
 ...
 // final UsernameCurrent usernameCurrent=UsernameCurrent();
  ...
  void saveDiscusions(){
    final DatabaseDiscussions databaseDiscussions=DatabaseDiscussions();
   databaseDiscussions.getDocument(chatParams.peer.uid);
    databaseDiscussions.saveDiscusions(chatParams.peer.uid, chatParams.peer.name);
  }
